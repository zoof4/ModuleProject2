from src.gpt.api import analyze_multiple_results
from src.gpt.response_format import (
    get_system_prompt,
    format_gpt_response,
    save_result,
    get_risk_badge
...
mock_scan_result = [
    ...
    },
    {
        ...
        "recommendation": "X-Frame-Options 헤더를 DENY로 설정하세요."
    }
]

print("GPT API 호출 중...")
prompt = get_system_prompt()
raw = analyze_multiple_results(mock_scan_result, prompt)
